...
(() => {
  var result;
  result = true;
  return utest.truthy(45, result);
})();

(() => {
  var result;
  result = false;
  return utest.falsy(50, result);
})();
...
(() => {
  var result;
  result = true;
  return nonorm.truthy(65, result);
})();

(() => {
  var result;
  result = false;
  return nonorm.falsy(70, result);
})();
...
(function() {
  ...
  return custom.equal(131, '  abc  ', 'ABC');
})();
...
(function() {
  ...
  custom = new CustomTester();
  return custom.equal(154, " 3.14159 ", "3.9");
})();
...
(function() {
  ...
  custom = new CustomTester();
  return custom.equal(170, 'meaningOfLife', 42);
})();
